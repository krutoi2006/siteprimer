    ...
    return () => (
      props.isMobile ? (
        ...
        >
          ...
          >
            <div
              class={`absolute inset-0 flex items-start justify-end border border-stone-200 bg-stone-100 p-3 shadow-[0_18px_34px_rgba(0,0,0,0.09)] transition-all duration-1000 ease-[cubic-bezier(0.25,0.1,0.25,1)] ${
            ...
            <div
              class={`absolute inset-0 border border-slate-300/40 transition-all duration-1000 ease-[cubic-bezier(0.25,0.1,0.25,1)] ${
            ...
            />
            <div
              class={`absolute inset-0 flex items-center justify-center border border-stone-100 bg-white/80 shadow-[0_0_24px_rgba(0,0,0,0.04)] backdrop-blur-md transition-all duration-1000 ease-[cubic-bezier(0.25,0.1,0.25,1)] ${
                isExpanded.value ? '[transform:translateZ(46px)]' : '[transform:translateZ(32px)]'
              }`}
            >
              <div class="rounded-full border border-white/60 bg-white/50 px-3 py-1.5 text-center backdrop-blur-lg">
            ...
            />
            <div
              class={`absolute inset-0 flex items-end border border-stone-400 bg-stone-300 p-3 opacity-95 shadow-[18px_24px_40px_rgba(0,0,0,0.18)] transition-all duration-1000 ease-[cubic-bezier(0.25,0.1,0.25,1)] ${
