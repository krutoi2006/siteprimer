...
import { Menu, X, ArrowRight, ChevronDown, Wind, Shield, Clock, Smartphone } from 'lucide-react';
...
export default function App() {
  ...
  // Единая централизованная логика блокировки скролла (Прелоадер, Модалка, Меню)
  useEffect(() => {
    if (isLoading || isModalOpen || isMenuOpen) {
      document.body.style.overflow = 'hidden';
    } else {
      document.body.style.overflow = ''; // Пустая строка надежно возвращает скролл браузера по умолчанию
    }
    
    return () => {
      document.body.style.overflow = '';
    };
  }, [isLoading, isModalOpen, isMenuOpen]);
  ...
  return (
    <div className="font-sans text-stone-900 bg-stone-50 min-h-screen overflow-x-hidden selection:bg-stone-300 selection:text-stone-900">
      ...
      {/* Глобальные стили для бронзового текста и анимаций */}
      ...
      {isLoading && (
        ...
        >
          <div className={`transform transition-all duration-[3000ms] ease-out ${isFadingOut ? 'scale-105 blur-sm' : 'scale-100 blur-0'}`}>
            <img 
              src="photo_2026-03-27_19-51-24.jpg" 
      ...
      <section id="hero" className="relative h-screen w-full bg-stone-950 overflow-hidden">
        ...
        <div className="relative z-40 h-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col justify-end pb-24 md:pb-32">
          ...
          <Reveal isReady={appReady} delay={400}>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-light bronze-text-light tracking-tighter leading-[1.1] mb-8 max-w-4xl">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
            <div className="lg:col-span-5">
              <Reveal>
                <h2 className="text-3xl md:text-5xl font-light tracking-tighter bronze-text leading-tight">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="mb-24 md:text-center max-w-3xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-4xl md:text-6xl font-light tracking-tighter bronze-text mb-6">
        ...
        {isMobilePortrait ? (
          <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center p-8 text-center max-w-sm">
              <img 
                src="photo_2026-03-27_19-51-24.jpg" 
                alt="Brand Logo" 
                className="w-48 opacity-30 mix-blend-screen mb-12"
              />
              <div className="relative w-24 h-24 mb-6 flex items-center justify-center">
                <Smartphone size={56} strokeWidth={1} className="text-[#f8d5a6] absolute" style={{ animation: 'phoneRotate 2.5s ease-in-out infinite' }} />
              </div>
              <h3 className="text-2xl font-light bronze-text-light uppercase tracking-widest mb-4">
                Переверните экран
              </h3>
          ...
          <div className={`max-w-7xl mx-auto px-6 md:px-12 w-full py-16 md:py-0 ${isMobile && !isMobilePortrait ? 'animate-projects-reveal' : ''}`}>
            <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-24">
              ...
              <Reveal delay={200}>
                <button className="text-sm font-medium border border-[#a67c52] text-[#f8d5a6] px-6 py-3 hover:bg-[#a67c52] hover:text-stone-950 transition-colors duration-300">
                  ...
                  <div className="relative overflow-hidden aspect-[21/9] bg-stone-800">
                    ...
                    <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                      <div>
                        ...
                        <p className="text-[#dcb589] tracking-wider text-sm">СТОКГОЛЬМСКИЙ АРХИПЕЛАГ</p>
                      </div>
                      <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center">
                        <ArrowRight size={20} className="text-[#f8d5a6]" />
                      </div>
                    </div>
                  </div>
                </Reveal>
                  ...
                  <div className="relative overflow-hidden aspect-[4/5] bg-stone-800">
                    ...
                    <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                      <div>
                        ...
                        <p className="text-[#dcb589] tracking-wider text-xs">МАЛИБУ, КАЛИФОРНИЯ</p>
                      </div>
                    </div>
                  </div>
                </Reveal>
                  ...
                  <div className="relative overflow-hidden aspect-[4/5] bg-stone-800">
                    ...
                    <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                      <div>
                        ...
                        <p className="text-[#dcb589] tracking-wider text-xs">АСПЕН, КОЛОРАДО</p>
                      </div>
                    </div>
                  </div>
                </Reveal>
      ...
      <section id="studio" className="py-32 bg-stone-50 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <Reveal>
            <h2 className="text-4xl md:text-6xl font-light tracking-tighter bronze-text mb-8">
